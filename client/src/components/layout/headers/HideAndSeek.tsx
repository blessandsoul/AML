...
export function HideAndSeek(props: SharedHeaderProps) {
    ...
    const isVisible = props.scrollDirection === 'up' || props.isAtTop || props.scrollYValue < 100;
    const isCompact = !props.isAtTop && isVisible;
                ...
                <div
                    className={cn(
                        ...
                        props.isAtTop
                            ...
                            : "bg-background/90 backdrop-blur-xl border border-border shadow-lg rounded-2xl"
                    )}
                >
                    {/* Logo */}
