...
export const NotificationItem = ({
    ...
    const handleClick = useCallback(() => {
        if (onMarkRead) {
            // If parent provided specific handler (which might do redirect), call it.
            // We pass ids array if it expects it, but for redirect logic we might override it in parent.
            // The parent `handleNotificationClick` calls `handleMarkAsRead` internally.
            // So here we just invoke the prop.
