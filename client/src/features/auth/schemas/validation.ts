...
// Helper for type inference (still useful if needed, though we primarily use the dynamic one)
// We define a dummy schema for static type inference to avoid needing `t` just for types
const dummyRegisterSchema = z.object({
  email: z.string(),
  password: z.string(),
  firstName: z.string(),
  lastName: z.string(),
});
export type RegisterFormData = z.infer<typeof dummyRegisterSchema>;
...
const dummyCompanyRegisterSchema = z.object({
  email: z.string(),
  password: z.string(),
  firstName: z.string(),
  lastName: z.string(),
...
export type CompanyRegisterFormData = z.infer<typeof dummyCompanyRegisterSchema>;

const dummyForgotPasswordSchema = z.object({
  email: z.string(),
});
export type ForgotPasswordFormData = z.infer<typeof dummyForgotPasswordSchema>;
...
const dummyResetPasswordSchema = z.object({
  newPassword: z.string(),
  confirmPassword: z.string(),
});
export type ResetPasswordFormData = z.infer<typeof dummyResetPasswordSchema>;
