...
import { useMyDriver, useUpdateDriver, useDeleteDriver, useUploadDriverPhotos, useDeleteDriverPhoto } from '../../hooks/useDriver';
...
const driverFormSchema = z.object({
    ...
    // Use string for capacity in form to avoid coercion issues during typing, parse on submit
...
// We need a specific type for the default values which can be numbers or strings
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                                <div className="space-y-1">
                                    ...
                                    <p className="font-medium">{driver.vehicleMake} {driver.vehicleModel} ({driver.vehicleType})</p>
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="font-medium">{driver.vehicleCapacity} {t('driver.passengers', 'passengers')}</p>
                                </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 border border-destructive/30 rounded-lg bg-destructive/5">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('driver.delete_desc', 'Once deleted, your driver profile and all associated data will be removed.')}
                            </p>
                        </div>
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle>
                                        {t('driver.delete_confirm_title', 'Are you sure?')}
                                    </AlertDialogTitle>
                                    <AlertDialogDescription>
                                        {t('driver.delete_confirm_desc', 'This action cannot be undone. Your driver profile will be permanently removed.')}
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
