...
export const DriverInfo = ({ driver, className }: DriverInfoProps) => {
    ...
    // Mock availability based on isAvailable
    const availability = {
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <div className="mb-8 p-6 bg-muted/30 rounded-xl border border-border/50">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col">
                                ...
                                <span className="font-medium">{driver.vehicleMake} {driver.vehicleModel}</span>
                            </div>
                            <div className="flex flex-col">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="font-medium">{driver.vehicleCapacity} Passengers</span>
                            </div>
                            <div className="flex flex-col">
                ...
                {photos.length > 0 && (
                    <TabsContent value="photos" className="p-6 md:p-8 mt-0">
                        <div className="mb-6">
                            <h3 className="text-lg font-semibold text-foreground mb-4">
                                {t('driver_details.gallery_title', 'Vehicle & Driver Photos')}
                            </h3>
                            <ImageGallery
                                images={photos.map(p => ({
                                    id: p.id,
