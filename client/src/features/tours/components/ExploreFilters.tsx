...
export const ExploreFilters = ({ type }: ExploreFiltersProps) => {
            ...
            const timer = setTimeout(() => {
                ...
                if (localValue !== currentUrlValue) {
                    setSearchParams(prev => {
                        ...
                        if (localValue) {
                            newParams.set(paramKey, localValue);
                        } else {
    ...
    const hasActiveFilters = useMemo(() => {
        return locationId || sortBy || minRating || minPrice || maxPrice || search ||
            difficulty || minDuration || maxDuration || maxPeople ||
            language || minExperience || vehicleType || minCapacity || hasActiveTours;
    }, [locationId, sortBy, minRating, minPrice, maxPrice, search, difficulty,
        minDuration, maxDuration, maxPeople, language, minExperience, vehicleType,
        minCapacity, hasActiveTours]);
