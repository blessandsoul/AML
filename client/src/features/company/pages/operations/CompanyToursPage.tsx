...
import { Map, Calendar, Pencil, Trash2 } from 'lucide-react';
...
export const CompanyToursPage = () => {
    ...
    const columns: ColumnDef<Tour>[] = useMemo(() => [
        {
            header: t('company.operations.tours.table.title'),
            cell: (tour) => (
                <div className="font-medium">
                    <Link to={ROUTES.TOURS.DETAILS(tour.id)} className="hover:underline flex items-center gap-2">
        ...
        {
            header: t('company.operations.tours.table.location'),
            cell: (tour) => (
        ...
        {
            header: t('company.operations.tours.table.price'),
            cell: (tour) => (
                <div className="font-medium">
        ...
        {
            header: t('company.operations.tours.table.status'),
            cell: (tour) => (
                <Badge
        ...
        {
            header: t('company.operations.tours.table.created'),
            cell: (tour) => (
    ...
    return (
        <div className="space-y-6">
            ...
            <DataTable
                ...
                emptyState={{
                    icon: Map,
                    title: t('company.operations.tours.empty_state')
                }}
            />
