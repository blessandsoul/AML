...
import { useMyCompany, useUpdateCompany, useDeleteCompany, useUploadCompanyPhotos, useDeleteCompanyPhoto } from '../hooks/useCompany';
    ...
    if (error) {
        return (
            <div className="max-w-4xl space-y-8 animate-fade-in">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">{t('company.management.title', 'Company Management')}</h2>
        ...
        <div className="max-w-4xl space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <Badge
                    ...
                    className={company.isVerified ? 'text-green-600 border-green-200 bg-green-50' : 'text-amber-600 bg-amber-50'}
                >
                    {company.isVerified ? (
                        <>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            {t('company.management.company_info_desc', 'Update your company details and contact information')}
                        </CardDescription>
                    </div>
                    {!isEditing && (
                    ...
                    {isEditing ? (
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {/* Registration Number */}
                                <div className="space-y-2">
                                    <Label htmlFor="registrationNumber">{t('company.registration_number', 'Registration Number')}</Label>
                                    <div className="relative">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-1">
                                    <p className="text-sm text-muted-foreground">{t('company.registration_number', 'Registration Number')}</p>
                                    <p className="font-medium flex items-center gap-2">
                            ...
                            {company.description && (
                                <div className="space-y-1">
                                    <p className="text-sm text-muted-foreground">{t('company.description', 'Description')}</p>
                ...
                <CardContent className="space-y-4">
                    ...
                    {company.photos && company.photos.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-8 text-center text-muted-foreground">
                            ...
                            <p className="text-sm">{t('company.photos.upload_hint', 'Upload photos to showcase your company')}</p>
                        </div>
                    )}
                </CardContent>
            </Card>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 border border-destructive/30 rounded-lg bg-destructive/5">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('company.delete_company_warning', 'Once deleted, your company and all associated data will be removed.')}
                            </p>
                        </div>
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle>
                                        {t('company.delete_dialog.title', 'Are you sure you want to delete your company?')}
                                    </AlertDialogTitle>
                                    <AlertDialogDescription>
                                        {t('company.delete_dialog.description', 'This action cannot be undone. Your company profile, tours, and all associated data will be permanently removed.')}
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
