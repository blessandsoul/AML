...
export const ProfileGeneral = ({ user }: ProfileGeneralProps) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{t('profile.general.avatar_title')}</CardTitle>
                    <CardDescription>{t('profile.general.avatar_desc')}</CardDescription>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{t('profile.general.personal_info')}</CardTitle>
                    <CardDescription>{t('profile.general.personal_info_desc')}</CardDescription>
                </CardHeader>
