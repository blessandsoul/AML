...
|------------------|-----------|
| Setting up a new module, adding files, organizing code | `project-conventions.md` |
| Creating or modifying a route / controller | `project-conventions.md` + `response-handling.md` |
| Returning data from an endpoint | `response-handling.md` |
| Returning a list with pagination | `pagination.md` |
| Handling or throwing errors | `response-handling.md` |
| Writing service or business logic | `project-conventions.md` (Service Layer Rules) |
| Changing the database schema | `db-and-migrations.md` + `migrations.md` |
| Adding indexes or relationships | `db-and-migrations.md` |
| Running or fixing migrations | `migrations.md` |
| Understanding the overall architecture or stack | `general-rules.md` |
| Unsure where to start | `general-rules.md` then this file |
